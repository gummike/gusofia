package com.tongbanjie.gusofia.thread.future;
...
public class RunnableFutureTask {
    ...
    static void futureDemo() {
        try {
            ...
            FutureTask<Integer> futureTask2 = new FutureTask<Integer>(new Runnable() {
                @Override
                public void run() {
                    fibc(20);
                }
            ...
            // 提交futureTask
            mExecutor.submit(futureTask2);
            System.out.println("future result from futureTask2 : " + futureTask2.get());
